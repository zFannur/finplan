...
class AddDependenceDialog extends StatefulWidget {
  const AddDependenceDialog({
    super.key,
  });

  @override
  State<AddDependenceDialog> createState() => _AddDependenceDialogState();
}

class _AddDependenceDialogState extends State<AddDependenceDialog> {
